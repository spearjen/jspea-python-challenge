...
with open(csvpath,"r") as csvfile:
    ...
    #This is printing to file across the top.  I'm guessing it doesn't need to be a list...
    data = [str(f"There are {lines} months of data contained in the dataset."),
            str(f"The total profit/loss for all months and years in the dataset is: {currencytotal}."),
